...
BuildNial       | The sdirectory to build a package with various features
...
3. Test that the nial executable is working by running it interactively.
   ...
   A header of the following form should appear:
   ...
   the tutorial library functio "teach". Run nial interactively, then at 
   the prompt type:
...
The README.md describes the process for selecting additional features 
